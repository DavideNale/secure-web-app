    ...
    <div class="flex flex-col h-screen">
        ...
        <div class="flex-grow bg-black">
            <div class="flex flex-col-reverse md:flex-row h-full">
                ...
                <div class="flex-none w-full md:w-96 bg-white md:border-l-[1.5px] border-b-[1.5px]">
                    <!-- FORM -->
                    <div class="">
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-3 text-sm">
                                    <label for="terms" class="font-light text-gray-500">I <a
                                            class="font-medium text-blue-600 hover:underline" href="#">Reviewed</a> the
                                        data</label>
                                </div>
                            </div>
                            <button type="submit"
                                class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Add
                                Patient</button>
                        </form>
                    </div>
                </div>
